...
public class Drive : MonoBehaviour
{
    ...
    public void Go(float accel, float steer, float brake)
    {
        ...
        //float thrustTorque = accel * torque; With this original line the will continue accelerating
        float thrustTorque = 0;
        if(currentSpeed < maxSpeed) //With this line the speed will have a maz speed
    ...
    /*void Update() //The update was moved to the Player Controller Script and called from there
    {
