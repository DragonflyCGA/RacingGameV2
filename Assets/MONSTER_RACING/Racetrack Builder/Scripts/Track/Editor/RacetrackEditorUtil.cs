...
public static class RacetrackEditorUtil
{
    ...
    public static void ConfigureRacetrackObjectDefaults(GameObject obj, out Racetrack racetrack, out RacetrackCurve curve, RacetrackMeshTemplate template = null)
    {
        ...
        // Set racetrack defaults.
        racetrack.RemoveInternalFaces = true;
        racetrack.BankAngleInterpolation = Racetrack1DInterpolationType.Bezier;
    ...
    public static void DrawRacetrackPath(RacetrackCurve selectedCurve, Racetrack track, out RacetrackSegment firstSeg, out RacetrackSegment lastSeg)
    {
        // Render track path
        var path = track.Path;
        ...
        for (int i = 0; i < path.Segments.Count; i++)
        {
            ...
            bool isCurve = selectedCurve != null && seg.Curve.Index == selectedCurve.Index;
            ...
            // Find first/last segment of current curve
            if (isCurve)
            {
                if (firstSeg == null)
                    firstSeg = seg;
