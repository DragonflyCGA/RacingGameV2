...
public class RacetrackEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        {
            if (showAllSettings)
                RacetrackEditorUtil.PropertyEditors(obj, true, "SegmentLength", "BankAngleInterpolation", "RemoveInternalFaces", "RespawnHeight", "RespawnZOffset");
    ...
    public void OnSceneGUI()
    {
        ...
        RacetrackEditorUtil.DrawRacetrackPath(null, track, out firstSeg, out lastSeg);
